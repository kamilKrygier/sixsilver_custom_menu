...
<div id="six_top_bar">
    <div class="six_top_bar_inner_wrapper">
        <a href="<?php echo get_home_url(); ?>">
            <img src="https://sixsilver.pl/wp-content/uploads/2021/09/sixsilver-jubiler-logo.png" alt="SIXSILVER JUBILER">
        </a>
    </div>
    <div class="six_top_bar_inner_wrapper right">
        <!-- <div class="six_top_bar_wishlist_wrapper">
            <a href="https://sixsilver.pl/?page_id=26863&preview=true"><img <?php 
            if(!is_page(26863))echo 'src="https://sixsilver.pl/wp-content/uploads/2022/06/sixsilver-jubiler-topbar-wishlista.svg"';
                else echo 'src="https://sixsilver.pl/wp-content/uploads/2022/06/sixsilver-jubiler-topbar-wishlista-active.svg"';
                ?> alt="Lista życzeń"></a>
        </div> -->
        <div class="six_top_bar_account_wrapper">
            ...
            else echo '<img src="https://sixsilver.pl/wp-content/uploads/2022/06/sixsilver-jubiler-menu-account.svg" alt="Moje konto">';
            ?></span></a>
        </div>
    </div>
</div>
    ...
    <div class="six_tap_bar_inner">
        <div class="six_tap_bar_icon_wrapper">
            <a href="<?php echo get_home_url(); ?>">
                ...
                {
                ?>
                    <img src="https://sixsilver.pl/wp-content/uploads/2022/06/sixsilver-jubiler-menu-home-active.svg" alt="">
                ...
                {
                ?>
                    <img src="https://sixsilver.pl/wp-content/uploads/2022/06/sixsilver-jubiler-menu-home.svg" alt="">
        ...
        <div class="six_tap_bar_icon_wrapper search">
            <img src="https://sixsilver.pl/wp-content/uploads/2022/06/sixsilver-jubiler-menu-lupa.svg" alt="">
        ...
        <div class="six_tap_bar_icon_wrapper center nav-menu">
            <div class="six_tap_bar_icon_inner_wrapper">
                <img src="https://sixsilver.pl/wp-content/uploads/2022/06/sixsilver-jubiler-menu-kategorie.svg" alt="">
            </div>
        ...
        <div class="six_tap_bar_icon_wrapper cart">
            <img src="https://sixsilver.pl/wp-content/uploads/2022/06/sixsilver-jubiler-menu-koszyk.svg" alt="">
            <p style="text-align:center;">Koszyk</p>
        </div>
        <div class="six_tap_bar_icon_wrapper">
            <a href="https://sixsilver.pl/?page_id=30415&preview=true">
                <?php
                    if(is_page(30415))
                    {
                    ?>
                        <img src="https://sixsilver.pl/wp-content/uploads/2022/06/sixsilver-jubiler-menu-telefon-active.svg" alt="">
                    ...
                    {
                    ?>
                        <img src="https://sixsilver.pl/wp-content/uploads/2022/06/sixsilver-jubiler-menu-telefon.svg" alt="">
...
<div class="six_cart_popup">
    <div class="six_cart_popup_inner_wrapper">
        <img class="six_cart_popup_close" style="float:right; width: 24px;height: 24px;cursor: pointer;" src="https://sixsilver.pl/wp-content/uploads/2022/06/sixsilver-jubiler-menu-xmark.svg" alt="Zamknij">
...
<div class="six_nav_popup">
    <div class="six_nav_popup_inner_wrapper">
        <img class="six_nav_popup_close" style="float:right; width: 24px;height: 24px;cursor: pointer;" src="https://sixsilver.pl/wp-content/uploads/2022/06/sixsilver-jubiler-menu-xmark.svg" alt="Zamknij">
...
<script>
    ...
    jQuery('#six_mobile_nav .menu-item').find('.sub-menu').parent('.menu-item').append('<div class="six_menu_toggle_icon_wrapper"><img src="https://sixsilver.pl/wp-content/uploads/2022/06/sixsilver-jubiler-menu-chevron-down.svg" alt=""></div>');
    ...
    function hideSearchPopup()
    {
        ...
        jQuery('.six_tap_bar_icon_wrapper.search > img').attr('src', 'https://sixsilver.pl/wp-content/uploads/2022/06/sixsilver-jubiler-menu-lupa.svg');
    ...
    function hideNavPopup()
    {
        ...
        jQuery('.six_tap_bar_icon_wrapper.nav-menu > div > img').attr('src', 'https://sixsilver.pl/wp-content/uploads/2022/06/sixsilver-jubiler-menu-kategorie.svg');
    ...
    function hideCartPopup()
    {
        ...
        jQuery('html').removeClass('disable_scroll');
        jQuery('.six_tap_bar_icon_wrapper.cart > img').attr('src', 'https://sixsilver.pl/wp-content/uploads/2022/06/sixsilver-jubiler-menu-koszyk.svg');
    ...
    function showCartPopup()
    {
        ...
        jQuery('.six_tap_bar_icon_wrapper.cart > img').delay(100).attr('src', 'https://sixsilver.pl/wp-content/uploads/2022/06/sixsilver-jubiler-menu-koszyk-active.svg');
    ...
    jQuery('.six_tap_bar_icon_wrapper.search').click(function(){
        ...
        else
        {
            ...
            jQuery('.six_tap_bar_icon_wrapper.search > img').attr('src', 'https://sixsilver.pl/wp-content/uploads/2022/06/sixsilver-jubiler-menu-lupa-active.svg');
    ...
    jQuery('.six_tap_bar_icon_wrapper.nav-menu').click(function(){
        ...
        else
        {
            ...
            jQuery('.six_tap_bar_icon_wrapper.nav-menu > div > img').attr('src', 'https://sixsilver.pl/wp-content/uploads/2022/06/sixsilver-jubiler-menu-xmark.svg');
